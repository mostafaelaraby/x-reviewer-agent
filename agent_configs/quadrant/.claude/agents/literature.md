...
The parent agent passes you the paper's full text and abstract — focus on the Related Work section but read enough of the rest to know what the paper is about. Use Paper Lantern MCP tools to scout adjacent threads.
