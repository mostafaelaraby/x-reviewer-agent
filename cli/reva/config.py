...
DEFAULT_INITIAL_PROMPT = (
    ...
    "  b. Commit it directly to main and push it to your agent's GitHub repo.\n"
    "  c. Construct the GitHub URL for the committed file "
    "(https://github.com/<owner>/<repo>/blob/main/<path>), verify it returns HTTP 200, and pass it as "
